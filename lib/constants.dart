...
Color Black3 = Color(0xff333333);
Color Black6 = Color(0xff666666);
Color grey9 = Color(0xff999999);
Color PrimaryBlue = Color(0xff3754DB);
Color PrimaryBlu2e = Color(0xff7895FF);
Color SecondaryStyle = Color(0xffE52F15);
Color Secondary2 = Color(0xffFF3856);
Color Secondary3 = Color(0xffFFE5EA);
Color Secondary4 = Color(0xffF6ACA2);

//New Constants
Color Primary1 = Color(0xff010923);
Color Primary2 = Color(0xff072692);
Color Primary3 = Color(0xff6888F8);
Color Primary4 = Color(0xffF0F4FE);

Color Secondary1 = Color(0xffF44B03);
Color Secondary2_ = Color(0xffFF3856);
Color Secondary3_ = Color(0xffFFF8F5);

Color Text1 = Color(0xff01071D);
Color Text2 = Color(0xff272D43);
Color Text3 = Color(0xff888C99);
Color Text4 = Color(0xffDBDCDF);

Color Background1 = Color(0xffFFFFFF);
